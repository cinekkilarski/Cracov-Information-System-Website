...
class RegisterForm extends Component {
    ...
    formRegisterValidation = () => {
        ...
        if (this.state.confirm_password.length >= 1 && this.state.confirm_password === this.state.password) {
        ...
        if (email_ver && password_ver && first_name_empty_ver && last_name_empty_ver && email_empty_ver && password_empty_ver && confirm_password_empty_ver && confirm_password_ver) {
            result = true
        }
        return ({
            email_ver,
            ...
            <div className="modalLog" >
                <form className="modalContentLog" onSubmit={this.handleSubmit} noValidate>
                    ...
                    <div className="container">
                        ...
                        {err_first_name_empty && <Alert className='errormessage' > {empty_input}  </Alert>}
                        <input type="text" name="first_name" placeholder="Enter First Name" value={this.state.first_name} onChange={this.handleInputChange} />

                        <label ><b>Last Name</b></label>
                        {err_last_name_empty && <Alert className='errormessage' > {empty_input}  </Alert>}
                        <input type="text" placeholder="Enter Last Name" name="last_name" value={this.state.last_name} onChange={this.handleInputChange} />
                        ...
                        <input type="password" placeholder="Enter Password" name="password" value={this.state.password} onChange={this.handleInputChange} />

                        <label ><b> Confirm Password</b></label>
                        {err_confirm_pass && <Alert className='errormessage' >{err_confirm_pass_empty ? empty_input : confirm_password_incorrect} </Alert>}
                        <input type="password" placeholder="Confirm Password" name="confirm_password" value={this.state.confirm_password} onChange={this.handleInputChange} />
                    ...
                    <div className="container  containerbotton">
                        ...
                        <button className="loginbutton changeformbtn" onClick={this.props.changeForm}>Login</button>
                    </div>
                </form>
