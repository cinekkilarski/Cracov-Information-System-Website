...
const HomePage = () => {
    ...
    const icons = iconsData.map(icon => {
        return (
            <div key={icon.iconName} className="iconDiv">
                <i id='homeicons' className="material-icons" >{icon.iconName}</i>
                <p>{icon.text}</p>
            </div>
        )
    })
    ...
    return (
        <div>
            ...
            <div id='imgDiv'>
                <img src="http://localhost:8080/api/image/zakrzowek.jpg" alt="zakrzowek" />
                <img src="http://localhost:8080/api/image/clothhall.jpg" alt="zakrzowek" />
